...
In this example, there are `_13_` rolls of paper that can be accessed by a
...
Once a roll of paper can be accessed by a forklift, it can be _removed_. Once
a roll of paper is removed, the forklifts might be able to access _more_ rolls
...
many rolls of paper as possible, using highlighted `_@_` to indicate that a
roll of paper is about to be removed, and using `x` to indicate that a roll of
...
example, a total of `_43_` rolls of paper can be removed.
