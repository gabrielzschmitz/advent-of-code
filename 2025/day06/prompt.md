...
her [math homework](/2021/day/18).

Cephalopod math doesn't look that different from normal math. The math
worksheet (your puzzle input) consists of a list of _problems_ ; each problem
has a group of numbers that need to be either _added_ (`+`) or _multiplied_
(`*`) together.
...
grand total is `33210` \+ `490` \+ `4243455` \+ `401` = `_4277556_`.
