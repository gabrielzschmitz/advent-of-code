/**
 * @file part1.cpp
 * @brief Wizard Simulator: Minimum Mana for Victory
 *
 * This program simulates a turn-based battle between a player (wizard) and a
 * boss in a role-playing game. The player starts with 50 hit points and 500
 * mana points, and the goal is to determine the least amount of mana the player
 * can spend to defeat the boss. 
 *
 ...
 * if they cannot afford any spell. The boss has specific stats provided in the
 * puzzle input.
 *
 * The program calculates the minimum mana spent by the player to win the
 * battle.
 *
