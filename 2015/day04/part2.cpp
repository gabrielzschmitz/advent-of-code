 ...
 * combined with a secret key, produces an MD5 hash starting with at least six
 ...
 * appended to the secret key, generates an MD5 hash starting with six zeroes.
 *
 * Puzzle Input:
 * - Secret key: ckczppom
 *
...
int main(int argc, char* argv[]) {
  ...
  while (true) {
    ...
    if (hash.substr(0, 6) == "000000") break;
  ...
  int32_t total = number_to_append;
