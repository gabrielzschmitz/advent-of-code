/**
 * @file part1.cpp
 * @brief RPG Battle Simulator: Minimum Cost Victory
 *
 * This program simulates a turn-based RPG battle between the player and a boss. 
 * The player must equip items from a shop to defeat the boss, with the goal of 
 * spending the least amount of gold possible to ensure victory. 
 * 
 ...
 * 0 losing the fight.
 *
 * The task is to determine the least amount of gold required to equip items 
 * such that the player wins the fight against the boss, whose stats are
 ...
 *
 * The program outputs the minimum amount of gold needed to win.
 *
 * Puzzle Answer: [Minimum Gold Spent]
 *
